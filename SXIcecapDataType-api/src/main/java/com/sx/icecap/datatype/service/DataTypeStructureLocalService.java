...
public interface DataTypeStructureLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.sx.icecap.datatype.service.impl.DataTypeStructureLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the data type structure local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DataTypeStructureLocalServiceUtil} if injection and service tracking are not available.
	 */
