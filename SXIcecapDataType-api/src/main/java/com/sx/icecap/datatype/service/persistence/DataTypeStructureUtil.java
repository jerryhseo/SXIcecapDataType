...
package com.sx.icecap.datatype.service.persistence;
...
public class DataTypeStructureUtil {
	...
	public static DataTypeStructure remove(long dataTypeId)
		throws com.sx.icecap.datatype.exception.
			NoSuchDataTypeStructureException {
