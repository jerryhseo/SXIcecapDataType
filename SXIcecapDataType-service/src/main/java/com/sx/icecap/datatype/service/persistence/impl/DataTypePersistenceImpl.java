...
package com.sx.icecap.datatype.service.persistence.impl;
...
import com.sx.icecap.datatype.exception.NoSuchDataTypeException;
import com.sx.icecap.datatype.model.DataType;
import com.sx.icecap.datatype.model.impl.DataTypeImpl;
import com.sx.icecap.datatype.model.impl.DataTypeModelImpl;
import com.sx.icecap.datatype.service.persistence.DataTypePersistence;
import com.sx.icecap.datatype.service.persistence.DataTypeUtil;
import com.sx.icecap.datatype.service.persistence.impl.constants.SXDatatypePersistenceConstants;
...
public class DataTypePersistenceImpl
	...
	@Override
	@Reference(
		target = SXDatatypePersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.sx.icecap.datatype.model.DataType"),
			true);
	}

	@Override
	@Reference(
		target = SXDatatypePersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
	...
	private static final String _FILTER_SQL_SELECT_DATATYPE_WHERE =
		"SELECT DISTINCT {dataType.*} FROM SXDatatype_DataType dataType WHERE ";

	private static final String
		_FILTER_SQL_SELECT_DATATYPE_NO_INLINE_DISTINCT_WHERE_1 =
			"SELECT {SXDatatype_DataType.*} FROM (SELECT DISTINCT dataType.dataTypeId FROM SXDatatype_DataType dataType WHERE ";

	private static final String
		_FILTER_SQL_SELECT_DATATYPE_NO_INLINE_DISTINCT_WHERE_2 =
			") TEMP_TABLE INNER JOIN SXDatatype_DataType ON TEMP_TABLE.dataTypeId = SXDatatype_DataType.dataTypeId";

	private static final String _FILTER_SQL_COUNT_DATATYPE_WHERE =
		"SELECT COUNT(DISTINCT dataType.dataTypeId) AS COUNT_VALUE FROM SXDatatype_DataType dataType WHERE ";

	private static final String _FILTER_ENTITY_ALIAS = "dataType";

	private static final String _FILTER_ENTITY_TABLE = "SXDatatype_DataType";

	private static final String _ORDER_BY_ENTITY_ALIAS = "dataType.";

	private static final String _ORDER_BY_ENTITY_TABLE = "SXDatatype_DataType.";
